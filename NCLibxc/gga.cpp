...
// calculate f^{eff}/rho and v^{eff} for GGA
...
void NCLibxc::postlibxc_gga_eff(int xc_id, 
    ...
    )
    {
        ...
        std::vector<double> exc = libxc.gga_exc(rho0, rho1, sigma0, sigma1, sigma2);

        std::vector<double> vrho_1(rho0.size()), vrho_2(rho1.size());
        std::vector<double> vsigma_1(np), vsigma_2(np), vsigma_3(np);
        // Zero vectors for tau and laplacian derivatives (not used in GGA)
        std::vector<double> vlapl_1(lapl0.size(), 0.0), vlapl_2(lapl1.size(), 0.0);
        std::vector<double> vtau_1(tau0.size(), 0.0), vtau_2(tau1.size(), 0.0);

        libxc.gga_vxc(rho0, rho1, sigma0, sigma1, sigma2, vrho_1, vrho_2, vsigma_1, vsigma_2, vsigma_3);
        ...
        // Zero vectors for tau and laplacian derivatives (not used in GGA)
        std::vector<double> v2rholapl_1(rho0.size(), 0.0), v2rholapl_2(rho0.size(), 0.0), v2rholapl_3(rho0.size(), 0.0), v2rholapl_4(rho0.size(), 0.0);
        std::vector<double> v2rhotau_1(rho0.size(), 0.0), v2rhotau_2(rho0.size(), 0.0), v2rhotau_3(rho0.size(), 0.0), v2rhotau_4(rho0.size(), 0.0);
        std::vector<double> v2sigma2_1(np), v2sigma2_2(np), v2sigma2_3(np), v2sigma2_4(np), v2sigma2_5(np), v2sigma2_6(np);
        std::vector<double> v2sigmalapl_1(np, 0.0), v2sigmalapl_2(sigma1.size(), 0.0), v2sigmalapl_3(sigma1.size(), 0.0), v2sigmalapl_4(sigma1.size(), 0.0), v2sigmalapl_5(sigma1.size(), 0.0), v2sigmalapl_6(sigma1.size(), 0.0);
        std::vector<double> v2sigmatau_1(sigma1.size(), 0.0), v2sigmatau_2(sigma1.size(), 0.0), v2sigmatau_3(sigma1.size(), 0.0), v2sigmatau_4(sigma1.size(), 0.0), v2sigmatau_5(sigma1.size(), 0.0), v2sigmatau_6(sigma1.size(), 0.0);
        std::vector<double> v2lapl2_1(lapl0.size(), 0.0), v2lapl2_2(lapl0.size(), 0.0), v2lapl2_3(lapl0.size(), 0.0);
        std::vector<double> v2lapltau_1(lapl0.size(), 0.0), v2lapltau_2(lapl0.size(), 0.0), v2lapltau_3(lapl0.size(), 0.0), v2lapltau_4(lapl0.size(), 0.0);
        std::vector<double> v2tau2_1(tau0.size(), 0.0), v2tau2_2(tau0.size(), 0.0), v2tau2_3(tau0.size(), 0.0);

        libxc.gga_fxc(rho0, rho1, sigma0, sigma1, sigma2, v2rho2_1, v2rho2_2, v2rho2_3, v2rhosigma_1, v2rhosigma_2, v2rhosigma_3, v2rhosigma_4, v2rhosigma_5, v2rhosigma_6, v2sigma2_1, v2sigma2_2, v2sigma2_3, v2sigma2_4, v2sigma2_5, v2sigma2_6);
        ...
        libxc.gga_kxc(
            ...
            v3sigma3_7, v3sigma3_8, v3sigma3_9, v3sigma3_10
        );
    ...
    libxc.gga_lxc(rho0,rho1,sigma0,sigma1,sigma2,v4rho4_1,v4rho4_2,v4rho4_3,v4rho4_4,v4rho4_5,v4rho3sigma_1,v4rho3sigma_2,v4rho3sigma_3,v4rho3sigma_4,v4rho3sigma_5,v4rho3sigma_6,v4rho3sigma_7,v4rho3sigma_8,v4rho3sigma_9,v4rho3sigma_10,v4rho3sigma_11,v4rho3sigma_12,v4rho2sigma2_1,v4rho2sigma2_2,v4rho2sigma2_3,v4rho2sigma2_4,v4rho2sigma2_5,v4rho2sigma2_6,v4rho2sigma2_7,v4rho2sigma2_8,v4rho2sigma2_9,v4rho2sigma2_10,v4rho2sigma2_11,v4rho2sigma2_12,v4rho2sigma2_13,v4rho2sigma2_14,v4rho2sigma2_15,v4rho2sigma2_16,v4rho2sigma2_17,v4rho2sigma2_18,v4rhosigma3_1,v4rhosigma3_2,v4rhosigma3_3,v4rhosigma3_4,v4rhosigma3_5,v4rhosigma3_6,v4rhosigma3_7,v4rhosigma3_8,v4rhosigma3_9,v4rhosigma3_10,v4rhosigma3_11,v4rhosigma3_12,v4rhosigma3_13,v4rhosigma3_14,v4rhosigma3_15,v4rhosigma3_16,v4rhosigma3_17,v4rhosigma3_18,v4rhosigma3_19,v4rhosigma3_20,v4sigma4_1,v4sigma4_2,v4sigma4_3,v4sigma4_4,v4sigma4_5,v4sigma4_6,v4sigma4_7,v4sigma4_8,v4sigma4_9,v4sigma4_10,v4sigma4_11,v4sigma4_12,v4sigma4_13,v4sigma4_14,v4sigma4_15);
